...
function Navigation() {
    ...
    return (
        <>
            <Navbar expand="lg" style={{ backgroundColor: '#39CCCC', zIndex: 15151515 }} >
                <Container>
                    <Navbar.Brand to="/default" as={Link}>
                        <img src="\public\dottorio-high-resolution-logo.png" alt="Logo" width={200} />
                    </Navbar.Brand>

                    <Nav>
                        {
                            !user || user.role === 'paziente' ?
                                <NavDropdown title='Tutte le specializzazioni' className="d-flex align-items-center color-white specializzazioni-menu" id="basic-nav-dropdown">
                                    <div className="d-flex specializzazioni-container">
                                        <div className="mx-2">
                                            <div>
                        ...
                        <NavDropdown title={<img src="\public\icons8-user-64.png" width={40} />} id="basic-nav-dropdown">
                            {
                                user ?
                                    <>
                                    ...
                                    :
                                    <>
                                        <NavDropdown.Item to='/login' as={Link}>Accedi</NavDropdown.Item>
